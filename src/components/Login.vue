  ...
  <div class="container">
    ...
    <div class="atendente">
      <header class="header-atendente">
        ...
        <span><strong id="atendente-voice">Logar neste site<i class="fa-solid fa-volume-high" id="sound"></i></strong></span>
      </header>
    </div>
    <div class="body-login">
      <form class="card">
        ...
        <div class="card-content">
          ...
          <div class="row">
            <a v-on:click="login" class="btn col-2 ">ENTRAR</a>
          </div><br>
          <div class="voltar">
...
methods: {
    login() {
      ...
      if (this.email === emailAdmin && this.senha === senhaAdmin) {
        this.$router.push({ name: 'funcionalidadesPage' });
      } else {
